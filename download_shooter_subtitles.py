...
if __name__ == '__main__':
    ...
    movie_path = urllib.unquote(movie_path)
    if movie_path.startswith('file://'):
        movie_path = movie_path[7:]
    movie_dir = os.path.dirname(movie_path)
    ret, title_path = download_shooter_subtitle(movie_path, movie_dir)
    if ret:
        #title_path = '' + urllib.quote(title_path)
        print title_path,
    else:
        print 'not found',
